...
//   cout<<"singleCellDose is "<<singleCellDose<<endl;
//   cout<<"singleCellDoseStd is "<<singleCellDoseStd<<endl;
}
...
// 	    cout<<"singleCellDSB = "<<singleCellDSB<<endl;
// 	    cout<<"singleCellDSBStd = "<<singleCellDSBStd<<endl;
...
void ReadRadiationTransportInfo::SetSingleCellDSBUpperLowerBound(string upperOrLower)
{
  if (upperOrLower == "upper")
  {
    singleCellDSB = singleCellDSB + singleCellDSBStd;
  }
  if (upperOrLower == "lower")
  {
    singleCellDSB = singleCellDSB - singleCellDSBStd;
  }
  if (upperOrLower == "random")
  {
    singleCellDSB = singleCellDSB + singleCellDSBStd*(2*Rand2() - 1);
  }
...
//             cout<<"using indirectResults"<<endl;
            if (COIMethod == true)
            {
// 	      cout<<"cellDoseFractionMap.at(cellID) "<<cellDoseFractionMap.at(cellID)<<endl;
...
double ReadRadiationTransportInfo::Rand2()
{
